...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\Administrator\Desktop\Projects\PhonePe-Case-Study.jpg"),width= 600)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\Administrator\Desktop\Projects\PhonePe-PG-Payment-Gateway-Integration-complete-guide.jpg"),width=350)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\Administrator\Desktop\Projects\PhonePe-Statistics.jpg"),width= 600)
